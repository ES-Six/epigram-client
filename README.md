...
Import required React Bootstrap components within ```src/Login.jsx``` file or your custom component files:
...
4. Add `// @flow` to any files you want to type check (for example, to `src/Login.jsx`).
...
To try it, delete all the code in `src/Login.jsx` and replace it with any of the examples on its website. The [Basic Example](https://reacttraining.com/react-router/web/example/basic) is a good place to get started.
